...
| AI code review / correção          | GitHub Copilot Autofix, Semgrep Autofix, Devin, CodeRabbit, Codacy Guardrails |
...
+ OWASP ZAP para DAST
+ Copilot Autofix / Semgrep Autofix / CodeRabbit para correção assistida
```
